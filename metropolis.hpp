...
public:
  ...
  template <class URNG>
  std::vector<double> do_sweep(const gp::physics &pparams,
                            gaugeconfig<Group> &U,
                            ...
                            const bool &anisotropic = false)
  {
    ...
    {
      return sweep(U, engines, delta, N_hit, pparams.beta, pparams.xi,
                   pparams.anisotropic);
    }
  }
  ...
  void do_sweep(const size_t &i)
  {
    ...
    if ((*this).sparams.do_mcmc)
    {
      ...
      rate += this->do_sweep((*this).pparams, (*this).U, engines, (*this).sparams.delta,
