...
%\begin{equation}
%\begin{aligned}
%  &\frac{\partial M_1}{\partial U_{\rho}(z)} 
%  = 
%  \frac{1}{4} \sum_{\mu, \nu} \eta_\mu(x)
%  [ 
%\\
%  &
%  + (-i) U_\mu^{\dagger}(x) \delta_{x,z} U_\nu(x+\mu) 
%  \eta_{\nu}(x+\mu) \delta_{x+\mu+\nu, y}
%  \\
%  &+ U_\mu^{\dagger}(x) (+i) U_\nu(x+\mu) \delta_{x+\mu, y} 
%  \eta_{\nu}(x+\mu) \delta_{x+\mu+\nu, y}
%   \\
%  & - (-i) U_{\mu}^{\dagger}(x) \delta_{x,z} U_{\nu}^{\dagger}(x) 
%  \eta_{\nu}(x+\mu) \delta_{x,y}
%  \\
%  &- (+i) U_{\mu}^{\dagger}(x) U_{\nu}^{\dagger}(x) \delta_{x,z} 
%  \eta_{\nu}(x+\mu) \delta_{x,y}
%  \\
%  &
%  - (+i) U_{\mu}(x-\mu) \delta_{x-\mu, z} U_{\nu}(x-\mu) 
%  \eta_{\nu}(x-\mu) \delta_{x-\mu-\nu,y}
%  \\
%  &- U_{\mu}(x-\mu) (+i) U_{\nu}(x-\mu) \delta_{x-\mu, z} 
%  \eta_{\nu}(x-\mu) \delta_{x-\mu-\nu,y}
%   \\
%  &
%  + (+i) U_{\mu}(x-\mu) \delta_{x-\mu, z} U_{\nu}^{\dagger}(x-\mu-\nu) 
