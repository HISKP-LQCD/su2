...
void gradient_flow(const gaugeconfig<Group> &U,
  ...
  // definine a fictitious gauge configuration Vt, momenta and hamiltonian field to evolve
  // with the flow
  ...
  gaugemonomial<double, Group> SW(0); // gradient flow for the Wilson (pure) gauge action
