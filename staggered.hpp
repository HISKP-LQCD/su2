...
#pragma omp end declare target
  ...
  spinor_lat<Float, Type> operator*(const DDdag_matrix_lat<Float, Type, Group> &M,
    ...
    //             std::array<int, nd_max> xm = x; // will be x-mu
    //             std::array<int, nd_max> xp = x; // will be x+mu
    //             std::array<int, nd_max> xpp = x; // will be  x + mu + nu
    //             std::array<int, nd_max> xpm = x; // will be x + mu - nu
    //             std::array<int, nd_max> xmp = x; // will be  x - mu + nu
    //             std::array<int, nd_max> xmm = x; // will be x - mu - nu
    ...
    //                 phi(x) +=
    //                   -fact_eta_x_mu * fact_nu_pp * (*U)(x, mu) * (*U)(xp, nu) *
    //                   psi(xpp);
