...
parser.add_argument('-o', "--outputfolder", help = "the folder to save the outputfiles in", type = str)
...
while i < args.numit:
    ...
    os.system("python3 ~/code/su2/hadron/retrace.py -f" + str(args.inputfile) + "--outputfolder " + str(args.outputfolder))
    i += 1