// cg.hpp
/*
This file defines a general purpose, templated class that applies the conjugate gradient
(CG) algorithm for solving linear systems. Please recall that convergence is guaranteed
only for invertible hermitean matrices.
Reference: sec. 8.8.2 of Degrand-Lattice Methods for Quantum Chromodynamics
...
namespace cg {
   ...
   */
  template <class Float, class T, class LAmatrix, class LAvector> class LinearCG {
  private:
    LAmatrix A;
    LAvector b;
